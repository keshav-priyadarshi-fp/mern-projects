        ...
        <div className="col-xl-8 col-lg-10">
          <div className="header-content text-center">
            ...
            <ul className="header-btn">
              ...
              <li><a className="main-btn btn-two video-popup" href="https://www.youtube.com/watch?v=r44RKWyfcFw">WATCH THE VIDEO <i className="lni-play" /></a></li>
            </ul>
          </div> 
        </div>
      </div> 
        ...
        <div className="single-pricing mt-40">
          ...
          <div className="pricing-list">
            <ul>
              ...
              <li><i className="lni-check-mark-circle" /> Super friendly support team</li>
              <li><i className="lni-check-mark-circle" /> Awesome Support</li>
            </ul>
          </div>
          ...
          <div className="footer-newsletter">
            ...
            <div className="newsletter">
              <form action="#">
                ...
                <button type="submit"><i className="lni-angle-double-right" /></button>
              </form>
            </div>
